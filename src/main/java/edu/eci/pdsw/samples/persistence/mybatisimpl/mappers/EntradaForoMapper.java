...
public interface EntradaForoMapper {
    ...
    public EntradaForo getEntradaForo(@Param("identrada")int id);
    
    public void agregarComentarioAEntradaForo(@Param("identrada")int idEntradaForo,@Param("cometario")Comentario c);
